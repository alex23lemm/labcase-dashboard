...
This section shows the activity of the **`r dim(projects.df)[1]` registered projects** within serveral defined time intervals based on the activity of the respective project members.
