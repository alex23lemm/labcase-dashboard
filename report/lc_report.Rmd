...
g.last.7.days <- ggplot(proj.created.in.last.7.days.vec, 
                        aes(x = Date, y = Freq, group = 1)) + 
                        ...
                        ggtitle(paste0(year(date.of.extraction), ': ',
                                ...
                                ' overall)')) +
                        ylim(0, max(proj.created.in.last.7.days.vec$Freq) * 1.02) +
...
This section shows the activity of the **`r users.dim[1]` registered users** within serveral defined time intervals based on their login behavior on the LabCase web frontend.

* Users active **in last 7 days:** **`r user.activity.df$active.obs[2]`**
* Users active **in last 30 days:** **`r user.activity.df$active.obs[3]`**
* Users active **in last 60 days:** **`r user.activity.df$active.obs[4]`**
* Users active **in last 12 months:** **`r user.activity.df$active.obs[5]`**
